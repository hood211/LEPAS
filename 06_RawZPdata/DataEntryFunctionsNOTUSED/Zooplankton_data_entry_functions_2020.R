...
input1.5 <- function(ZF_list){
  ...
  write.csv(datasheet, paste0("Z:\\Projects\\FADX09_LEPAS\\15-LEPAS Datasheets\\Entered Spreadsheets\\3-Zooplankton\\LEPAS_", Year,"\\",Year,"-",Basin,"\\Entered\\", ZF_list$File[1,1]), na="")
